  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(101, 126, 253, 1);fontSize:25px;">爱心互助及物品回收管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="联系电话" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.lianxidianhua" autocomplete="off" placeholder="联系电话" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.lianxidizhi" class="input" type="text" placeholder="联系地址">
			   </div>
			 </div> -->
			<el-form-item label="联系地址" class="input" v-if="tableName=='yonghu'">
			  <el-input v-model="ruleForm.lianxidizhi" autocomplete="off" placeholder="联系地址" type="text" />
			</el-form-item>
