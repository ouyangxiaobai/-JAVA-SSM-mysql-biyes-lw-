          ...
          <el-form-item class="input" label="物品名称" prop="wupinmingcheng">
              <el-input v-model="ruleForm.wupinmingcheng" 
                placeholder="物品名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="爱心值" prop="aixinzhi">
          <el-input v-model="ruleForm.aixinzhi" 
              placeholder="爱心值" clearable  :readonly="ro.aixinzhi"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `aixinzhiqu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.aixinzhiquCrossAddOrUpdateFlag = false;
                  this.parent.search();
