<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="求助编码" prop="qiuzhubianma">
          <el-input v-model="ruleForm.qiuzhubianma" 
              placeholder="求助编码" clearable  :readonly="ro.qiuzhubianma"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="求助编码" prop="qiuzhubianma">
              <el-input v-model="ruleForm.qiuzhubianma" 
                placeholder="求助编码" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="求助信息" prop="qiuzhuxinxi">
          <el-input v-model="ruleForm.qiuzhuxinxi" 
              placeholder="求助信息" clearable  :readonly="ro.qiuzhuxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="求助信息" prop="qiuzhuxinxi">
              <el-input v-model="ruleForm.qiuzhuxinxi" 
                placeholder="求助信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="求助人" prop="qiuzhuren">
          <el-input v-model="ruleForm.qiuzhuren" 
              placeholder="求助人" clearable  :readonly="ro.qiuzhuren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="求助人" prop="qiuzhuren">
              <el-input v-model="ruleForm.qiuzhuren" 
                placeholder="求助人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="援助物品" prop="yuanzhuwupin">
          <el-input v-model="ruleForm.yuanzhuwupin" 
              placeholder="援助物品" clearable  :readonly="ro.yuanzhuwupin"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="援助物品" prop="yuanzhuwupin">
              <el-input v-model="ruleForm.yuanzhuwupin" 
                placeholder="援助物品" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="爱心值" prop="aixinzhi">
          <el-select v-model="ruleForm.aixinzhi" placeholder="请选择爱心值">
            <el-option
                v-for="(item,index) in aixinzhiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="爱心值" prop="aixinzhi">
	      <el-input v-model="ruleForm.aixinzhi"
                placeholder="爱心值" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="援助日期" prop="yuanzhuriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.yuanzhuriqi" 
                type="date"
                placeholder="援助日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yuanzhuriqi" label="援助日期" prop="yuanzhuriqi">
              <el-input v-model="ruleForm.yuanzhuriqi" 
                placeholder="援助日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='qiuzhubianma'){
            this.ruleForm.qiuzhubianma = obj[o];
	    this.ro.qiuzhubianma = true;
            continue;
          }
	            	            if(o=='qiuzhuxinxi'){
            this.ruleForm.qiuzhuxinxi = obj[o];
	    this.ro.qiuzhuxinxi = true;
            continue;
          }
	            	            if(o=='qiuzhuren'){
	    ...
	    this.ro.qiuzhuren = true;
            continue;
	            	            ...
	            	            if(o=='yuanzhuwupin'){
            this.ruleForm.yuanzhuwupin = obj[o];
	    this.ro.yuanzhuwupin = true;
            continue;
          }
	            	            if(o=='aixinzhi'){
            this.ruleForm.aixinzhi = obj[o];
	    this.ro.aixinzhi = true;
            continue;
          }
	            	            if(o=='zhanghao'){
	    ...
	    this.ro.lianxidianhua = true;
            continue;
	            	            ...
	            	            if(o=='yuanzhuriqi'){
            this.ruleForm.yuanzhuriqi = obj[o];
	    this.ro.yuanzhuriqi = true;
            continue;
          }
	                    }
                                                                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yuanzhu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yuanzhuCrossAddOrUpdateFlag = false;
                  this.parent.search();
