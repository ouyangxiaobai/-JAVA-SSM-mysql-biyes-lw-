      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="物品编号" prop="wupinbianhao">
          <el-input v-model="ruleForm.wupinbianhao" 
              placeholder="物品编号" clearable  :readonly="ro.wupinbianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="物品编号" prop="wupinbianhao">
              <el-input v-model="ruleForm.wupinbianhao" 
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="捐赠人" prop="juanzengren">
          <el-input v-model="ruleForm.juanzengren" 
              placeholder="捐赠人" clearable  :readonly="ro.juanzengren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="捐赠人" prop="juanzengren">
              <el-input v-model="ruleForm.juanzengren" 
                placeholder="捐赠人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.riqi" label="日期" prop="riqi">
              <el-input v-model="ruleForm.riqi" 
                placeholder="日期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="使用年限" prop="shiyongnianxian">
          <el-input v-model="ruleForm.shiyongnianxian" 
              placeholder="使用年限" clearable  :readonly="ro.shiyongnianxian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="使用年限" prop="shiyongnianxian">
              <el-input v-model="ruleForm.shiyongnianxian" 
                placeholder="使用年限" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.leibie"
                placeholder="类别" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="捐赠方式" prop="juanzengfangshi">
          <el-select v-model="ruleForm.juanzengfangshi" placeholder="请选择捐赠方式">
            <el-option
                v-for="(item,index) in juanzengfangshiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="捐赠方式" prop="juanzengfangshi">
	      <el-input v-model="ruleForm.juanzengfangshi"
                placeholder="捐赠方式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tupian = true;
            continue;
	            	            ...
	            	            if(o=='juanzengren'){
            this.ruleForm.juanzengren = obj[o];
	    this.ro.juanzengren = true;
            continue;
          }
	            	            if(o=='riqi'){
	    ...
	    this.ro.riqi = true;
            continue;
	            	            ...
	            	            if(o=='shiyongnianxian'){
            this.ruleForm.shiyongnianxian = obj[o];
	    this.ro.shiyongnianxian = true;
            continue;
          }
	            	            if(o=='leibie'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                                                      ...
                                                                                                                                                      this.leibieOptions = "生活用品,工具,闲置电器,其它".split(',')
                                        this.juanzengfangshiOptions = "送到,自取".split(',')
                                        this.aixinzhiOptions = "3".split(',')
                            },
                                                                                // 多级联动参数
                                                                                                      info(id) {
      this.$http({
        url: `wupinhuishou/info/${id}`,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `wupinhuishou/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wupinhuishouCrossAddOrUpdateFlag = false;
                  this.parent.search();
