          ...
          <el-form-item class="input" label="求助人" prop="qiuzhuren">
              <el-input v-model="ruleForm.qiuzhuren" 
                placeholder="求助人" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="求助人电话" prop="qiuzhurendianhua">
          <el-input v-model="ruleForm.qiuzhurendianhua" 
              placeholder="求助人电话" clearable  :readonly="ro.qiuzhurendianhua"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="求助人电话" prop="qiuzhurendianhua">
              <el-input v-model="ruleForm.qiuzhurendianhua" 
                placeholder="求助人电话" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.xiangguantupian" label="相关图片" prop="xiangguantupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.xiangguantupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="情况介绍" prop="qingkuangjieshao">
          <el-input v-model="ruleForm.qingkuangjieshao" 
              placeholder="情况介绍" clearable  :readonly="ro.qingkuangjieshao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="情况介绍" prop="qingkuangjieshao">
              <el-input v-model="ruleForm.qingkuangjieshao" 
                placeholder="情况介绍" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  data() {
	...
	qiuzhuxinxi : false,
	qiuzhuren : false,
	qiuzhurendianhua : false,
	xiangguantupian : false,
	qingkuangjieshao : false,
	shenqingriqi : false,
	zhanghao : false,
	xingming : false,
	lianxidianhua : false,
	                        	        ...
	                        	        lianxidianhua: '',
	                        	                        	        shhf: '',
	                        	                        	                        	        clicktime: '',
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            rules: {
                  qiuzhubianma: [
                            { required: true, message: '求助编码不能为空', trigger: 'blur' },
                                    	                                                              ],
                  qiuzhuxinxi: [
                            { required: true, message: '求助信息不能为空', trigger: 'blur' },
                                    	                                                              ],
                  qiuzhuren: [
                            { required: true, message: '求助人不能为空', trigger: 'blur' },
                                    	                                                              ],
                  qiuzhurendianhua: [
                                    	                                                              ],
                  xiangguantupian: [
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qiuzhuren = true;
            continue;
	            	            ...
	            	            if(o=='qiuzhurendianhua'){
            this.ruleForm.qiuzhurendianhua = obj[o];
	    this.ro.qiuzhurendianhua = true;
            continue;
          }
	    ...
	    this.ro.xiangguantupian = true;
            continue;
	            	            ...
	            	            if(o=='qingkuangjieshao'){
            this.ruleForm.qingkuangjieshao = obj[o];
	    this.ro.qingkuangjieshao = true;
            continue;
          }
	            	            if(o=='shenqingriqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `qiuzhuxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.qiuzhuxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
