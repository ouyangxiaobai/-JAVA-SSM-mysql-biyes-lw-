...
export default {
  data() {
	...
	clicknum : false,
            ...
            ruleForm: {
                  ...
                  juanzhuduixiang: [
                            { required: true, message: '捐助对象不能为空', trigger: 'blur' },
                                    	                                                              ],
                  aixinzhi: [
                                    	                                                              ],
                  xiangguantupian: [
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `aixinxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.aixinxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
