      ...
      <el-row>
          ...
          <el-form-item class="input" v-if="ruleForm.gonggaobianhao" label="公告编号" prop="gonggaobianhao">
              <el-input v-model="ruleForm.gonggaobianhao" 
                placeholder="公告编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公告信息" prop="gonggaoxinxi">
          <el-input v-model="ruleForm.gonggaoxinxi" 
              placeholder="公告信息" clearable  :readonly="ro.gonggaoxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公告信息" prop="gonggaoxinxi">
              <el-input v-model="ruleForm.gonggaoxinxi" 
                placeholder="公告信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公告内容" prop="gonggaoneirong">
          <el-input v-model="ruleForm.gonggaoneirong" 
              placeholder="公告内容" clearable  :readonly="ro.gonggaoneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公告内容" prop="gonggaoneirong">
              <el-input v-model="ruleForm.gonggaoneirong" 
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.gonggaotupian" label="公告图片" prop="gonggaotupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.gonggaotupian.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                      </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gonggaobianhao = true;
            continue;
	            	            ...
	            	            if(o=='gonggaoxinxi'){
            this.ruleForm.gonggaoxinxi = obj[o];
	    this.ro.gonggaoxinxi = true;
            continue;
          }
	            	            if(o=='gonggaoneirong'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `wangzhangonggao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.wangzhangonggaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
