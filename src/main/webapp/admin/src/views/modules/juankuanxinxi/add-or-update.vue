<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="捐款编号" prop="juankuanbianhao">
            <el-input v-model="ruleForm.juankuanbianhao" 
                placeholder="捐款编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.juankuanbianhao" label="捐款编号" prop="juankuanbianhao">
              <el-input v-model="ruleForm.juankuanbianhao" 
                placeholder="捐款编号" readonly></el-input>
          </el-form-item>
        </div>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="捐款金额" prop="juankuanjine">
          <el-input v-model="ruleForm.juankuanjine" 
              placeholder="捐款金额" clearable  :readonly="ro.juankuanjine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="捐款金额" prop="juankuanjine">
              <el-input v-model="ruleForm.juankuanjine" 
                placeholder="捐款金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.aixinzhi"
                placeholder="爱心值" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="收款对象" prop="shoukuanduixiang">
          <el-input v-model="ruleForm.shoukuanduixiang" 
              placeholder="收款对象" clearable  :readonly="ro.shoukuanduixiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="收款对象" prop="shoukuanduixiang">
              <el-input v-model="ruleForm.shoukuanduixiang" 
                placeholder="收款对象" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  data() {
    ...
    return {
      ...
      type: '',
      ro:{
	juankuanbianhao : false,
	juankuanjine : false,
	aixinzhi : false,
	shoukuanduixiang : false,
	zhanghao : false,
	xingming : false,
                        	        ...
                        	        juankuanjine: '',
	                        	        ...
	                        	        shenfenzhenghaoma: '',
                                                    ...
                                                    aixinzhiOptions: [],
                                                                                                                      rules: {
                  juankuanbianhao: [
                            { required: true, message: '捐款编号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  juankuanjine: [
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='juankuanbianhao'){
            this.ruleForm.juankuanbianhao = obj[o];
	    this.ro.juankuanbianhao = true;
            continue;
          }
	            	            if(o=='juankuanjine'){
	    ...
	    this.ro.aixinzhi = true;
            continue;
	            	            ...
	            	            if(o=='shoukuanduixiang'){
            this.ruleForm.shoukuanduixiang = obj[o];
	    this.ro.shoukuanduixiang = true;
            continue;
          }
	            	            if(o=='zhanghao'){
        ...
        if (data && data.code === 0) {
          var json = data.data;
              		...
              		this.ruleForm.xingming = json.xingming
                                  		...
                                  		if(json.shenfenzhenghaoma!=''&&json.shenfenzhenghaoma){
              		this.ruleForm.shenfenzhenghaoma = json.shenfenzhenghaoma
		}
                                                                                                } else {
