...
public class WangzhangonggaoController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,WangzhangonggaoEntity wangzhangonggao, HttpServletRequest request){
    ...
    public R info(@PathVariable("id") Long id){
		...
		wangzhangonggao.setClicknum(wangzhangonggao.getClicknum()+1);
		wangzhangonggao.setClicktime(new Date());
		wangzhangonggaoService.updateById(wangzhangonggao);
    ...
    public R thumbsup(@PathVariable("id") String id,String type){
        WangzhangonggaoEntity wangzhangonggao = wangzhangonggaoService.selectById(id);
        if(type.equals("1")) {
        	wangzhangonggao.setThumbsupnum(wangzhangonggao.getThumbsupnum()+1);
        } else {
        	wangzhangonggao.setCrazilynum(wangzhangonggao.getCrazilynum()+1);
        }
        wangzhangonggaoService.updateById(wangzhangonggao);
        return R.ok();
    }
    ...
    public R autoSort(@RequestParam Map<String, Object> params,WangzhangonggaoEntity wangzhangonggao, HttpServletRequest request,String pre){
        EntityWrapper<WangzhangonggaoEntity> ew = new EntityWrapper<WangzhangonggaoEntity>();
