...
public class DiscusswangzhangonggaoController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscusswangzhangonggaoEntity discusswangzhangonggao, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscusswangzhangonggaoEntity discusswangzhangonggao, HttpServletRequest request){
        EntityWrapper<DiscusswangzhangonggaoEntity> ew = new EntityWrapper<DiscusswangzhangonggaoEntity>();
		PageUtils page = discusswangzhangonggaoService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discusswangzhangonggao), params), params));
        return R.ok().put("data", page);
    }
